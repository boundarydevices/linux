...
#define MT8365_MUTEX_MOD_DISP_OVL0		BIT(7)
#define MT8365_MUTEX_MOD_DISP_OVL0_2L		BIT(8)
#define MT8365_MUTEX_MOD_DISP_RDMA0		BIT(9)
#define MT8365_MUTEX_MOD_DISP_RDMA1		BIT(10)
#define MT8365_MUTEX_MOD_DISP_WDMA0		BIT(11)
#define MT8365_MUTEX_MOD_DISP_COLOR0		BIT(12)
#define MT8365_MUTEX_MOD_DISP_CCORR		BIT(13)
#define MT8365_MUTEX_MOD_DISP_AAL		BIT(14)
#define MT8365_MUTEX_MOD_DISP_GAMMA		BIT(15)
#define MT8365_MUTEX_MOD_DISP_DITHER		BIT(16)
#define MT8365_MUTEX_MOD_DISP_DSI0		BIT(17)
#define MT8365_MUTEX_MOD_DISP_RSZ0		BIT(19)
#define MT8365_MUTEX_MOD_DISP_PWM0		BIT(20)
#define MT8365_MUTEX_MOD_DISP_DPI0		BIT(22)
...
static const u64 mt8365_mutex_mod[DDP_COMPONENT_ID_MAX] = {
