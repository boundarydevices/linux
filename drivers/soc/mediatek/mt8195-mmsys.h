...
#define MT8195_VDO0_DL_RELAY2_CFD		0x248
#define MT8195_VDO0_DL_RELAY3_CFD		0x24c
#define MT8195_VDO0_DL_RELAY4_CFD		0x250


#define MT8195_VDO1_SW0_RST_B					0x1d0
#define MT8195_VDO1_VDO0_DSC_CFG_WD				0xe10
#define MT8195_VDO1_VDO0_MERGE_CFG_WD				0xe20
#define MT8195_VDO1_MERGE0_ASYNC_CFG_WD				0xe30
#define MT8195_VDO1_HDRBE_ASYNC_CFG_WD				0xe70
#define MT8195_VDO1_OUT_CFG					0xee0
...
#define MT8195_DISP_DPI0_SEL_IN_FROM_VPP_MERGE4_MOUT			0
#define MT8195_DISP_DPI0_SEL_IN_FROM_VDO0_MERGE_DL_ASYNC_MOUT			1
#define MT8195_DISP_DPI0_SEL_IN_FROM_VDO0_DSC_DL_ASYNC_MOUT			2

#define MT8195_VDO1_DISP_DPI1_SEL_IN				0xf10
#define MT8195_DISP_DPI1_SEL_IN_FROM_VPP_MERGE4_MOUT			0
#define MT8195_DISP_DPI1_SEL_IN_FROM_VDO0_MERGE_DL_ASYNC_MOUT			1
#define MT8195_DISP_DPI1_SEL_IN_FROM_VDO0_DSC_DL_ASYNC_MOUT			2

#define MT8195_VDO1_DISP_DP_INTF0_SEL_IN			0xf14
#define MT8195_DISP_DP_INTF0_SEL_IN_FROM_VPP_MERGE4_MOUT		0
#define MT8195_DISP_DP_INTF0_SEL_IN_FROM_VDO0_MERGE_DL_ASYNC_MOUT			1
#define MT8195_DISP_DP_INTF0_SEL_IN_FROM_VDO0_DSC_DL_ASYNC_MOUT			2

#define MT8195_VDO1_MERGE4_SOUT_SEL				0xf18
#define MT8195_MERGE4_SOUT_TO_VDO0						0
#define MT8195_MERGE4_SOUT_TO_DPI1_SEL					2
#define MT8195_MERGE4_SOUT_TO_DP_INTF0_SEL				3

#define MT8195_VDO1_VDO0_DSC_DL_ASYNC_MOUT_EN			0xf1c
#define MT8195_VDO0_DSC_DL_ASYNC_TO_DPI0_SEL			BIT(0)
#define MT8195_VDO0_DSC_DL_ASYNC_TO_DPI1_SEL			BIT(1)
#define MT8195_VDO0_DSC_DL_ASYNC_TO_DP_INTF0_SEL			BIT(2)

#define MT8195_VDO1_VDO0_MERGE_DL_ASYNC_MOUT_EN			0xf20
#define MT8195_VDO0_DSC_MERGE_ASYNC_TO_DPI0_SEL			BIT(0)
#define MT8195_VDO0_DSC_MERGE_ASYNC_TO_DPI1_SEL			BIT(1)
#define MT8195_VDO0_DSC_MERGE_ASYNC_TO_DP_INTF0_SEL			BIT(2)
...
#define MT8195_VPP_SPLIT_OUT0_SOUT_SEL				0xf10
#define MT8195_VPP_SPLIT_OUT1_SOUT_SEL				0xf14

#define MT8195_VPP1_SW0_RST_B					0x700
#define MT8195_VPP1_SW1_RST_B					0x704
...
static const struct mtk_mmsys_routes mmsys_mt8195_vdo1_routing_table[] = {
	{
		...
		DDP_COMPONENT_MERGE5, DDP_COMPONENT_DP_INTF0,
		MT8195_VDO1_MERGE4_SOUT_SEL, GENMASK(1, 0),
		MT8195_MERGE4_SOUT_TO_VDO0
	}, {
		DDP_COMPONENT_MERGE0, DDP_COMPONENT_DPI1,
		MT8195_VDO1_DISP_DPI1_SEL_IN, GENMASK(1, 0),
		MT8195_DISP_DPI0_SEL_IN_FROM_VDO0_MERGE_DL_ASYNC_MOUT
	}, {
		DDP_COMPONENT_MERGE0, DDP_COMPONENT_DPI1,
		MT8195_VDO1_VDO0_MERGE_DL_ASYNC_MOUT_EN, GENMASK(2, 0),
		MT8195_VDO0_DSC_MERGE_ASYNC_TO_DPI1_SEL
	}, {
		DDP_COMPONENT_MERGE0, DDP_COMPONENT_DP_INTF1,
		MT8195_VDO1_DISP_DP_INTF0_SEL_IN, GENMASK(1, 0),
		MT8195_DISP_DP_INTF0_SEL_IN_FROM_VDO0_MERGE_DL_ASYNC_MOUT
	}, {
		DDP_COMPONENT_MERGE0, DDP_COMPONENT_DP_INTF1,
		MT8195_VDO1_VDO0_MERGE_DL_ASYNC_MOUT_EN, GENMASK(2, 0),
		MT8195_VDO0_DSC_MERGE_ASYNC_TO_DP_INTF0_SEL
	}, {
		DDP_COMPONENT_DITHER1, DDP_COMPONENT_DPI1,
		MT8195_VDO1_VDO0_MERGE_DL_ASYNC_MOUT_EN, GENMASK(2, 0),
		MT8195_VDO0_DSC_MERGE_ASYNC_TO_DPI1_SEL
...
static const u32 mmsys_mt8195_vdo0_main_sys_w_h_configs_list[] = {
	MT8195_VDO0_DL_RELAY3_CFD,
	MT8195_VDO0_DL_RELAY4_CFD
};

static const u32 mmsys_mt8195_vdo0_cross_sys_w_h_configs_list[] = {
	MT8195_VDO0_DL_RELAY2_CFD
};

static const u32 mmsys_mt8195_vdo1_main_sys_w_h_configs_list[] = {
	MT8195_VDO1_OUT_CFG
};

static const u32 mmsys_mt8195_vdo1_cross_sys_w_h_configs_list[] = {
	MT8195_VDO1_VDO0_DSC_CFG_WD,
	MT8195_VDO1_VDO0_MERGE_CFG_WD
};
