...
static struct lock_class_key max77823_irq_request_class;
				    ...
				    const struct i2c_device_id *id)
{
	...
	max77823->charger = i2c_new_dummy_device(client->adapter, I2C_ADDR_CHARGER);
	i2c_set_clientdata(max77823->charger, max77823);

	max77823->fuelgauge = i2c_new_dummy_device(client->adapter, I2C_ADDR_FUELGAUGE);
...
static void max77823_remove(struct i2c_client *client)
{
