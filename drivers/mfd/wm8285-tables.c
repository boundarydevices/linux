/*
 * wm8285-tables.c  --  data tables for WM8285 class codecs
 *
...
static const struct reg_default wm8285_reva_patch[] = {
	{ 0x80,  0x0003 },
	{ 0x213, 0x03E4 },
	{ 0x177, 0x0281 },
	{ 0x197, 0x0281 },
...
int wm8285_patch(struct arizona *arizona)
{
	...
	default:
		return regmap_register_patch(arizona->regmap,
					     wm8285_reva_patch,
					     ARRAY_SIZE(wm8285_reva_patch));
	}

	return 0;
}
EXPORT_SYMBOL_GPL(wm8285_patch);

static const struct regmap_irq wm8285_irqs[ARIZONA_NUM_IRQ] = {
	[ARIZONA_IRQ_BOOT_DONE] = { .reg_offset = 0,
				  .mask = WM8285_BOOT_DONE_EINT1 },
	[ARIZONA_IRQ_CTRLIF_ERR] = { .reg_offset = 0,
				  .mask = WM8285_CTRLIF_ERR_EINT1 },

	[ARIZONA_IRQ_FLL1_CLOCK_OK] = { .reg_offset = 1,
				  .mask = WM8285_FLL1_LOCK_EINT1 },
	[ARIZONA_IRQ_FLL2_CLOCK_OK] = { .reg_offset = 1,
				  .mask = WM8285_FLL2_LOCK_EINT1},
	[ARIZONA_IRQ_FLL3_CLOCK_OK] = { .reg_offset = 1,
				  .mask = WM8285_FLL3_LOCK_EINT1},

	[ARIZONA_IRQ_MICDET] = { .reg_offset = 5,
				  .mask = WM8285_MICDET_EINT1 },
	[ARIZONA_IRQ_HPDET] = { .reg_offset = 5,
				  .mask = WM8285_HPDET_EINT1},

	[ARIZONA_IRQ_MICD_CLAMP_RISE] = { .reg_offset = 6,
				  .mask = WM8285_MICD_CLAMP_RISE_EINT1 },
	[ARIZONA_IRQ_MICD_CLAMP_FALL] = { .reg_offset = 6,
				  .mask = WM8285_MICD_CLAMP_FALL_EINT1 },
	[ARIZONA_IRQ_JD_FALL] = { .reg_offset = 6,
				  .mask = WM8285_JD1_FALL_EINT1 },
	[ARIZONA_IRQ_JD_RISE] = { .reg_offset = 6,
				  .mask = WM8285_JD1_RISE_EINT1 },

	[ARIZONA_IRQ_ASRC2_LOCK] = { .reg_offset = 8,
				  .mask = WM8285_ASRC2_IN1_LOCK_EINT1 },
	[ARIZONA_IRQ_ASRC1_LOCK] = { .reg_offset = 8,
				  .mask = WM8285_ASRC1_IN1_LOCK_EINT1 },
	[ARIZONA_IRQ_DRC2_SIG_DET] = { .reg_offset = 8,
				  .mask = WM8285_DRC2_SIG_DET_EINT1 },
	[ARIZONA_IRQ_DRC1_SIG_DET] = { .reg_offset = 8,
				  .mask = WM8285_DRC1_SIG_DET_EINT1 },

	[ARIZONA_IRQ_DSP_IRQ1] = { .reg_offset = 10,
				  .mask = WM8285_DSP_IRQ1_EINT1},
	[ARIZONA_IRQ_DSP_IRQ2] = { .reg_offset = 10,
				  .mask = WM8285_DSP_IRQ2_EINT1},
	[ARIZONA_IRQ_DSP_IRQ3] = { .reg_offset = 10,
				  .mask = WM8285_DSP_IRQ3_EINT1},
	[ARIZONA_IRQ_DSP_IRQ4] = { .reg_offset = 10,
				  .mask = WM8285_DSP_IRQ4_EINT1},
	[ARIZONA_IRQ_DSP_IRQ5] = { .reg_offset = 10,
				  .mask = WM8285_DSP_IRQ5_EINT1},
	[ARIZONA_IRQ_DSP_IRQ6] = { .reg_offset = 10,
				  .mask = WM8285_DSP_IRQ6_EINT1},
	[ARIZONA_IRQ_DSP_IRQ7] = { .reg_offset = 10,
				  .mask = WM8285_DSP_IRQ7_EINT1},
	[ARIZONA_IRQ_DSP_IRQ8] = { .reg_offset = 10,
				  .mask = WM8285_DSP_IRQ8_EINT1},

	[ARIZONA_IRQ_SPK_OVERHEAT_WARN] = { .reg_offset = 14,
				.mask = WM8285_SPK_OVERHEAT_WARN_EINT1},
	[ARIZONA_IRQ_SPK_OVERHEAT] = { .reg_offset = 14,
				.mask = WM8285_SPK_SHUTDOWN_EINT1},
};

const struct regmap_irq_chip wm8285_irq = {
	.name = "wm8285 IRQ",
	.status_base = WM8285_IRQ1_STATUS_1,
	.mask_base = WM8285_IRQ1_MASK_1,
	.ack_base = WM8285_IRQ1_STATUS_1,
	.num_regs = 15,
	.irqs = wm8285_irqs,
	.num_irqs = ARRAY_SIZE(wm8285_irqs),
};
...
static bool wm8285_16bit_readable_register(struct device *dev, unsigned int reg)
{
	switch (reg) {
	...
	case WM8285_DSP_CLOCK_1:
	case WM8285_DSP_CLOCK_2:
	...
	case WM8285_DSP5LMIX_INPUT_1_SOURCE:
	case WM8285_DSP5LMIX_INPUT_1_VOLUME:
	case WM8285_DSP5LMIX_INPUT_2_SOURCE:
	case WM8285_DSP5LMIX_INPUT_2_VOLUME:
	case WM8285_DSP5LMIX_INPUT_3_SOURCE:
	case WM8285_DSP5LMIX_INPUT_3_VOLUME:
	case WM8285_DSP5LMIX_INPUT_4_SOURCE:
	case WM8285_DSP5LMIX_INPUT_4_VOLUME:
	case WM8285_DSP5RMIX_INPUT_1_SOURCE:
	case WM8285_DSP5RMIX_INPUT_1_VOLUME:
	case WM8285_DSP5RMIX_INPUT_2_SOURCE:
	case WM8285_DSP5RMIX_INPUT_2_VOLUME:
	case WM8285_DSP5RMIX_INPUT_3_SOURCE:
	case WM8285_DSP5RMIX_INPUT_3_VOLUME:
	case WM8285_DSP5RMIX_INPUT_4_SOURCE:
	case WM8285_DSP5RMIX_INPUT_4_VOLUME:
	case WM8285_DSP5AUX1MIX_INPUT_1_SOURCE:
	case WM8285_DSP5AUX2MIX_INPUT_1_SOURCE:
	case WM8285_DSP5AUX3MIX_INPUT_1_SOURCE:
	case WM8285_DSP5AUX4MIX_INPUT_1_SOURCE:
	case WM8285_DSP5AUX5MIX_INPUT_1_SOURCE:
	case WM8285_DSP5AUX6MIX_INPUT_1_SOURCE:
	case WM8285_ASRC1_1LMIX_INPUT_1_SOURCE:
	case WM8285_ASRC1_1RMIX_INPUT_1_SOURCE:
	case WM8285_ASRC1_2LMIX_INPUT_1_SOURCE:
	case WM8285_ASRC1_2RMIX_INPUT_1_SOURCE:
	case WM8285_ASRC2_1LMIX_INPUT_1_SOURCE:
	case WM8285_ASRC2_1RMIX_INPUT_1_SOURCE:
	case WM8285_ASRC2_2LMIX_INPUT_1_SOURCE:
	case WM8285_ASRC2_2RMIX_INPUT_1_SOURCE:
	...
	case WM8285_DSP6LMIX_INPUT_1_SOURCE:
	case WM8285_DSP6LMIX_INPUT_1_VOLUME:
	case WM8285_DSP6LMIX_INPUT_2_SOURCE:
	case WM8285_DSP6LMIX_INPUT_2_VOLUME:
	case WM8285_DSP6LMIX_INPUT_3_SOURCE:
	case WM8285_DSP6LMIX_INPUT_3_VOLUME:
	case WM8285_DSP6LMIX_INPUT_4_SOURCE:
	case WM8285_DSP6LMIX_INPUT_4_VOLUME:
	case WM8285_DSP6RMIX_INPUT_1_SOURCE:
	case WM8285_DSP6RMIX_INPUT_1_VOLUME:
	case WM8285_DSP6RMIX_INPUT_2_SOURCE:
	case WM8285_DSP6RMIX_INPUT_2_VOLUME:
	case WM8285_DSP6RMIX_INPUT_3_SOURCE:
	case WM8285_DSP6RMIX_INPUT_3_VOLUME:
	case WM8285_DSP6RMIX_INPUT_4_SOURCE:
	case WM8285_DSP6RMIX_INPUT_4_VOLUME:
	case WM8285_DSP6AUX1MIX_INPUT_1_SOURCE:
	case WM8285_DSP6AUX2MIX_INPUT_1_SOURCE:
	case WM8285_DSP6AUX3MIX_INPUT_1_SOURCE:
	case WM8285_DSP6AUX4MIX_INPUT_1_SOURCE:
	case WM8285_DSP6AUX5MIX_INPUT_1_SOURCE:
	case WM8285_DSP6AUX6MIX_INPUT_1_SOURCE:
	case WM8285_DSP7LMIX_INPUT_1_SOURCE:
	case WM8285_DSP7LMIX_INPUT_1_VOLUME:
	case WM8285_DSP7LMIX_INPUT_2_SOURCE:
	case WM8285_DSP7LMIX_INPUT_2_VOLUME:
	case WM8285_DSP7LMIX_INPUT_3_SOURCE:
	case WM8285_DSP7LMIX_INPUT_3_VOLUME:
	case WM8285_DSP7LMIX_INPUT_4_SOURCE:
	case WM8285_DSP7LMIX_INPUT_4_VOLUME:
	case WM8285_DSP7RMIX_INPUT_1_SOURCE:
	case WM8285_DSP7RMIX_INPUT_1_VOLUME:
	case WM8285_DSP7RMIX_INPUT_2_SOURCE:
	case WM8285_DSP7RMIX_INPUT_2_VOLUME:
	case WM8285_DSP7RMIX_INPUT_3_SOURCE:
	case WM8285_DSP7RMIX_INPUT_3_VOLUME:
	case WM8285_DSP7RMIX_INPUT_4_SOURCE:
	case WM8285_DSP7RMIX_INPUT_4_VOLUME:
	case WM8285_DSP7AUX1MIX_INPUT_1_SOURCE:
	case WM8285_DSP7AUX2MIX_INPUT_1_SOURCE:
	case WM8285_DSP7AUX3MIX_INPUT_1_SOURCE:
	case WM8285_DSP7AUX4MIX_INPUT_1_SOURCE:
	case WM8285_DSP7AUX5MIX_INPUT_1_SOURCE:
	case WM8285_DSP7AUX6MIX_INPUT_1_SOURCE:
	...
	case WM8285_DRC2_CTRL1:
	case WM8285_DRC2_CTRL2:
	case WM8285_DRC2_CTRL3:
	case WM8285_DRC2_CTRL4:
	case WM8285_DRC2_CTRL5:
	...
	case WM8285_FRF_COEFFICIENT_1L_4:
	case WM8285_FRF_COEFFICIENT_1R_1:
	case WM8285_FRF_COEFFICIENT_1R_2:
	case WM8285_FRF_COEFFICIENT_1R_3:
	case WM8285_FRF_COEFFICIENT_1R_4:
	case WM8285_FRF_COEFFICIENT_2L_1:
	case WM8285_FRF_COEFFICIENT_2L_2:
	case WM8285_FRF_COEFFICIENT_2L_3:
	case WM8285_FRF_COEFFICIENT_2L_4:
	case WM8285_FRF_COEFFICIENT_2R_1:
	case WM8285_FRF_COEFFICIENT_2R_2:
	case WM8285_FRF_COEFFICIENT_2R_3:
	case WM8285_FRF_COEFFICIENT_2R_4:
	case WM8285_FRF_COEFFICIENT_3L_1:
	case WM8285_FRF_COEFFICIENT_3L_2:
	case WM8285_FRF_COEFFICIENT_3L_3:
	case WM8285_FRF_COEFFICIENT_3L_4:
	case WM8285_FRF_COEFFICIENT_3R_1:
	case WM8285_FRF_COEFFICIENT_3R_2:
	case WM8285_FRF_COEFFICIENT_3R_3:
	case WM8285_FRF_COEFFICIENT_3R_4:
	case WM8285_FRF_COEFFICIENT_4L_1:
	case WM8285_FRF_COEFFICIENT_4L_2:
	case WM8285_FRF_COEFFICIENT_4L_3:
	case WM8285_FRF_COEFFICIENT_4L_4:
	case WM8285_FRF_COEFFICIENT_4R_1:
	case WM8285_FRF_COEFFICIENT_4R_2:
	case WM8285_FRF_COEFFICIENT_4R_3:
	case WM8285_FRF_COEFFICIENT_4R_4:
	case WM8285_FRF_COEFFICIENT_5L_1:
	case WM8285_FRF_COEFFICIENT_5L_2:
	case WM8285_FRF_COEFFICIENT_5L_3:
	case WM8285_FRF_COEFFICIENT_5L_4:
	case WM8285_FRF_COEFFICIENT_5R_1:
	case WM8285_FRF_COEFFICIENT_5R_2:
	case WM8285_FRF_COEFFICIENT_5R_3:
	case WM8285_FRF_COEFFICIENT_5R_4:
	case WM8285_FRF_COEFFICIENT_6L_1:
	case WM8285_FRF_COEFFICIENT_6L_2:
	case WM8285_FRF_COEFFICIENT_6L_3:
	case WM8285_FRF_COEFFICIENT_6L_4:
	case WM8285_FRF_COEFFICIENT_6R_1:
	case WM8285_FRF_COEFFICIENT_6R_2:
	case WM8285_FRF_COEFFICIENT_6R_3:
	case WM8285_FRF_COEFFICIENT_6R_4:
	case WM8285_GPIO1_CTRL_1:
	case WM8285_GPIO1_CTRL_2:
	case WM8285_GPIO2_CTRL_1:
	case WM8285_GPIO2_CTRL_2:
	case WM8285_GPIO3_CTRL_1:
	case WM8285_GPIO3_CTRL_2:
	case WM8285_GPIO4_CTRL_1:
	case WM8285_GPIO4_CTRL_2:
	case WM8285_GPIO5_CTRL_1:
	case WM8285_GPIO5_CTRL_2:
	case WM8285_GPIO6_CTRL_1:
	case WM8285_GPIO6_CTRL_2:
	case WM8285_GPIO7_CTRL_1:
	case WM8285_GPIO7_CTRL_2:
	case WM8285_GPIO8_CTRL_1:
	case WM8285_GPIO8_CTRL_2:
	case WM8285_GPIO9_CTRL_1:
	case WM8285_GPIO9_CTRL_2:
	case WM8285_GPIO10_CTRL_1:
	case WM8285_GPIO10_CTRL_2:
	case WM8285_GPIO11_CTRL_1:
	case WM8285_GPIO11_CTRL_2:
	case WM8285_GPIO12_CTRL_1:
	case WM8285_GPIO12_CTRL_2:
	case WM8285_GPIO13_CTRL_1:
	case WM8285_GPIO13_CTRL_2:
	case WM8285_GPIO14_CTRL_1:
	case WM8285_GPIO14_CTRL_2:
	case WM8285_GPIO15_CTRL_1:
	case WM8285_GPIO15_CTRL_2:
	case WM8285_GPIO16_CTRL_1:
	case WM8285_GPIO16_CTRL_2:
	case WM8285_GPIO17_CTRL_1:
	case WM8285_GPIO17_CTRL_2:
	case WM8285_GPIO18_CTRL_1:
	case WM8285_GPIO18_CTRL_2:
	case WM8285_GPIO19_CTRL_1:
	case WM8285_GPIO19_CTRL_2:
	case WM8285_GPIO20_CTRL_1:
	case WM8285_GPIO20_CTRL_2:
	case WM8285_GPIO21_CTRL_1:
	case WM8285_GPIO21_CTRL_2:
	case WM8285_GPIO22_CTRL_1:
	case WM8285_GPIO22_CTRL_2:
	case WM8285_GPIO23_CTRL_1:
	case WM8285_GPIO23_CTRL_2:
	case WM8285_GPIO24_CTRL_1:
	case WM8285_GPIO24_CTRL_2:
	case WM8285_GPIO25_CTRL_1:
	case WM8285_GPIO25_CTRL_2:
	case WM8285_GPIO26_CTRL_1:
	case WM8285_GPIO26_CTRL_2:
	case WM8285_GPIO27_CTRL_1:
	case WM8285_GPIO27_CTRL_2:
	case WM8285_GPIO28_CTRL_1:
	case WM8285_GPIO28_CTRL_2:
	case WM8285_GPIO29_CTRL_1:
	case WM8285_GPIO29_CTRL_2:
	case WM8285_GPIO30_CTRL_1:
	case WM8285_GPIO30_CTRL_2:
	case WM8285_GPIO31_CTRL_1:
	case WM8285_GPIO31_CTRL_2:
	case WM8285_GPIO32_CTRL_1:
	case WM8285_GPIO32_CTRL_2:
	case WM8285_GPIO33_CTRL_1:
	case WM8285_GPIO33_CTRL_2:
	case WM8285_GPIO34_CTRL_1:
	case WM8285_GPIO34_CTRL_2:
	case WM8285_GPIO35_CTRL_1:
	case WM8285_GPIO35_CTRL_2:
	case WM8285_GPIO36_CTRL_1:
	case WM8285_GPIO36_CTRL_2:
	case WM8285_GPIO37_CTRL_1:
	case WM8285_GPIO37_CTRL_2:
	case WM8285_GPIO38_CTRL_1:
	case WM8285_GPIO38_CTRL_2:
	case WM8285_GPIO39_CTRL_1:
	case WM8285_GPIO39_CTRL_2:
	case WM8285_GPIO40_CTRL_1:
	case WM8285_GPIO40_CTRL_2:
	case WM8285_IRQ1_STATUS_1:
	case WM8285_IRQ1_STATUS_2:
	case WM8285_IRQ1_STATUS_6:
	case WM8285_IRQ1_STATUS_7:
	case WM8285_IRQ1_STATUS_9:
	case WM8285_IRQ1_STATUS_11:
	case WM8285_IRQ1_STATUS_12:
	case WM8285_IRQ1_STATUS_13:
	case WM8285_IRQ1_STATUS_14:
	case WM8285_IRQ1_STATUS_15:
	case WM8285_IRQ1_STATUS_17:
	case WM8285_IRQ1_STATUS_18:
	case WM8285_IRQ1_STATUS_19:
	case WM8285_IRQ1_STATUS_21:
	case WM8285_IRQ1_STATUS_22:
	case WM8285_IRQ1_STATUS_23:
	case WM8285_IRQ1_STATUS_24:
	case WM8285_IRQ1_STATUS_25:
	case WM8285_IRQ1_STATUS_27:
	case WM8285_IRQ1_STATUS_28:
	case WM8285_IRQ1_STATUS_30:
	case WM8285_IRQ1_STATUS_31:
	...
	case WM8285_IRQ1_MASK_14:
	case WM8285_IRQ1_MASK_15:
	case WM8285_IRQ1_MASK_17:
	case WM8285_IRQ1_MASK_18:
	case WM8285_IRQ1_MASK_19:
	case WM8285_IRQ1_MASK_21:
	case WM8285_IRQ1_MASK_22:
	case WM8285_IRQ1_MASK_23:
	case WM8285_IRQ1_MASK_24:
	case WM8285_IRQ1_MASK_25:
	case WM8285_IRQ1_MASK_27:
	case WM8285_IRQ1_MASK_28:
	case WM8285_IRQ1_MASK_30:
	case WM8285_IRQ1_MASK_31:
	case WM8285_IRQ1_MASK_32:
	case WM8285_IRQ1_RAW_STATUS_1:
	case WM8285_IRQ1_RAW_STATUS_2:
	case WM8285_IRQ1_RAW_STATUS_7:
	case WM8285_IRQ1_RAW_STATUS_9:
	case WM8285_IRQ1_RAW_STATUS_11:
	case WM8285_IRQ1_RAW_STATUS_12:
	case WM8285_IRQ1_RAW_STATUS_13:
	case WM8285_IRQ1_RAW_STATUS_14:
	case WM8285_IRQ1_RAW_STATUS_15:
	case WM8285_IRQ1_RAW_STATUS_17:
	case WM8285_IRQ1_RAW_STATUS_18:
	case WM8285_IRQ1_RAW_STATUS_19:
	case WM8285_IRQ1_RAW_STATUS_21:
	case WM8285_IRQ1_RAW_STATUS_22:
	case WM8285_IRQ1_RAW_STATUS_23:
	case WM8285_IRQ1_RAW_STATUS_24:
	case WM8285_IRQ1_RAW_STATUS_25:
	case WM8285_IRQ1_RAW_STATUS_30:
	case WM8285_IRQ1_RAW_STATUS_31:
	case WM8285_IRQ1_RAW_STATUS_32:
...
static bool wm8285_16bit_volatile_register(struct device *dev, unsigned int reg)
{
	switch (reg) {
	case ARIZONA_SOFTWARE_RESET:
	case ARIZONA_DEVICE_REVISION:
...
static bool wm8285_32bit_readable_register(struct device *dev, unsigned int reg)
{
	switch (reg) {
	case ARIZONA_WSEQ_SEQUENCE_1 ... ARIZONA_WSEQ_SEQUENCE_508:
	case WM8285_DSP1_CONFIG ... WM8285_DSP1_SCRATCH_3:
	case WM8285_DSP2_CONFIG ... WM8285_DSP2_SCRATCH_3:
	case WM8285_DSP3_CONFIG ... WM8285_DSP3_SCRATCH_3:
	case WM8285_DSP4_CONFIG ... WM8285_DSP4_SCRATCH_3:
	case WM8285_DSP5_CONFIG ... WM8285_DSP5_SCRATCH_3:
	case WM8285_DSP6_CONFIG ... WM8285_DSP6_SCRATCH_3:
	case WM8285_DSP7_CONFIG ... WM8285_DSP7_SCRATCH_3:
		return true;
	default:
		return wm8285_is_adsp_memory(dev, reg);
	}
}

static bool wm8285_32bit_volatile_register(struct device *dev, unsigned int reg)
{
	switch (reg) {
	case ARIZONA_WSEQ_SEQUENCE_1 ... ARIZONA_WSEQ_SEQUENCE_508:
	case WM8285_DSP1_CONFIG ... WM8285_DSP1_SCRATCH_3:
...
const struct regmap_config wm8285_16bit_spi_regmap = {
	.name = "wm8285_16bit",
	.reg_bits = 32,
	.pad_bits = 16,
	.val_bits = 16,
	...
	.max_register = 0x2fff,
	.readable_reg = wm8285_16bit_readable_register,
	.volatile_reg = wm8285_16bit_volatile_register,

	.cache_type = REGCACHE_RBTREE,
	.reg_defaults = wm8285_reg_default,
	.num_reg_defaults = ARRAY_SIZE(wm8285_reg_default),
};
EXPORT_SYMBOL_GPL(wm8285_16bit_spi_regmap);

const struct regmap_config wm8285_16bit_i2c_regmap = {
	.name = "wm8285_16bit",
	.reg_bits = 32,
	.val_bits = 16,
...
EXPORT_SYMBOL_GPL(wm8285_16bit_i2c_regmap);

const struct regmap_config wm8285_32bit_spi_regmap = {
	.name = "wm8285_32bit",
	.reg_bits = 32,
	.reg_stride = 2,
	.pad_bits = 16,
	...
	.max_register = WM8285_DSP7_SCRATCH_3,
	.readable_reg = wm8285_32bit_readable_register,
	.volatile_reg = wm8285_32bit_volatile_register,

	.cache_type = REGCACHE_NONE,
};
EXPORT_SYMBOL_GPL(wm8285_32bit_spi_regmap);
...
EXPORT_SYMBOL_GPL(wm8285_32bit_i2c_regmap);
