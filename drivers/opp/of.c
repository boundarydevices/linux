...
int dev_pm_opp_of_add_table_indexed_np(struct device *dev, int index, bool getclk, struct device_node *np,
		struct device_node **ref_np, int max_tables)
{
	...
	while (i < max_tables) {
		...
		opp_table = _add_opp_table_indexed(dev, index, getclk, opp_np);
		if (IS_ERR(opp_table))
...
EXPORT_SYMBOL_GPL(dev_pm_opp_of_add_table_indexed_np);
...
int dev_pm_opp_of_add_table(struct device *dev)
{
	...
	return dev_pm_opp_of_add_table_indexed_np(dev, 0, true, dev->of_node, &opp_np, 1);
}
...
int dev_pm_opp_of_add_table_indexed(struct device *dev, int index)
{
	...
	return dev_pm_opp_of_add_table_indexed_np(dev, index, true, dev->of_node, &opp_np, 1);
}
...
int dev_pm_opp_of_add_table_noclk(struct device *dev, int index)
{
	...
	return dev_pm_opp_of_add_table_indexed_np(dev, index, false, dev->of_node, &opp_np, 1);
}
