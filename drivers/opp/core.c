...
static struct opp_table *_opp_get_opp_table(struct device *dev, struct device_node *np, int index)
{
	struct opp_table *opp_table;
	struct device_node *np1 = NULL;
...
{
	return _opp_get_opp_table(dev, NULL, 0);
}
...
struct opp_table *dev_pm_opp_get_opp_table_np(struct device *dev,
			struct device_node *np)
{
	return _opp_get_opp_table(dev, np, 0);
}
...
{
	return _opp_get_opp_table(dev, np, index);
}
