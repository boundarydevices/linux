...
/** Firmware ready */
#define FIRMWARE_READY          0xfedcba00
...
#define HostCmd_CMD_DPD_LOG_EN     0x026b
#define HostCmd_CMD_GET_DPD_LOG     0x026c
...
#define EVENT_DPD_LOG           0x00000091
...
/** HostCmd_DS_DPD_LOG_EN */
typedef MLAN_PACK_START struct _HostCmd_DS_DPD_LOG_EN {
    /** Action */
	t_u16 action;
    /** enable */
	t_u8 enable;
} MLAN_PACK_END HostCmd_DS_DPD_LOG_EN;

/** HostCmd_DS_GET_DPD_LOG */
typedef MLAN_PACK_START struct _HostCmd_DS_GET_DPD_LOG {
    /** dpd log */
	dpdlog_t dpdlog;
} MLAN_PACK_END HostCmd_DS_GET_DPD_LOG;
...
/* #ifdef SLEEP_COOKIE */
	...
	t_u32 sleep_cookie_addr_lo;
	t_u32 sleep_cookie_addr_hi;
/* #endif */
...
typedef struct MLAN_PACK_START _HostCmd_DS_COMMAND {
	...
	/** Get log */
		HostCmd_DS_GET_DPD_LOG get_dpdlog;
		/** enable DPD log */
		HostCmd_DS_DPD_LOG_EN dpdlog_en;
