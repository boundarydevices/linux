...
#endif	/* CONFIG_PWRCTRL */
extern u8 setconnectionctrl_cmd(_adapter* adapter, u32 enable, u32 time);
extern u8 disconnectCtrlEx_cmd(PADAPTER padapter, u8 enableDrvCtrl, u8 tryPktCnt, u8 tryPktInterval, u32 firstStageTO);
