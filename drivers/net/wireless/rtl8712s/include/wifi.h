...
#define GetSequence(pbuf)	(cpu_to_le16(*(unsigned short *)((addr_t)(pbuf) + 22)) >> 4)

#define GetFragNum(pbuf)	(cpu_to_le16(*(unsigned short *)((addr_t)(pbuf) + 22)) & 0x0f)

#define GetTupleCache(pbuf)	(cpu_to_le16(*(unsigned short *)((addr_t)(pbuf) + 22)))

#define SetFragNum(pbuf, num) \
	do {    \
		*(unsigned short *)((addr_t)(pbuf) + 22) = \
			((*(unsigned short *)((addr_t)(pbuf) + 22)) & le16_to_cpu(~(0x000f))) | \
...
#define SetSeqNum(pbuf, num) \
	do {    \
		*(unsigned short *)((addr_t)(pbuf) + 22) = \
			((*(unsigned short *)((addr_t)(pbuf) + 22)) & le16_to_cpu((unsigned short)~0xfff0)) | \
			le16_to_cpu((unsigned short)(0xfff0 & (num << 4))); \
	} while(0)

#define SetDuration(pbuf, dur) \
	do {    \
		*(unsigned short *)((addr_t)(pbuf) + 2) |= cpu_to_le16(0xffff & (dur)); \
	} while(0)
...
#define GetAid(pbuf)	(cpu_to_le16(*(unsigned short *)((addr_t)(pbuf) + 2)) & 0x3fff)

#define GetTid(pbuf)	(cpu_to_le16(*(unsigned short *)((addr_t)(pbuf) + (((GetToDs(pbuf)<<1)|GetFrDs(pbuf))==3?30:24))) & 0x000f)
