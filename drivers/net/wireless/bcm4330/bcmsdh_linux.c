...
/*Begin: Added by fangxiaozhi for SW OOB level mode*/
#elif defined(OOB_SW_LEVEL)
	irq_flags = IORESOURCE_IRQ_HIGHLEVEL;
/*End: Added by fangxiaozhi for SW OOB level mode*/
#else
...
void bcmsdh_oob_intr_set(bool enable)
{
	...
	unsigned long flags;
	//enable = 0;//fangxiaozhi added for test
...
static irqreturn_t wlan_oob_irq(int irq, void *dev_id)
{
	...
	irq_level = gpio_get_value(56);
	read_wifi_irq();
	//if (irq_level == 1) {
		//printk(KERN_ERR"fxz-%s: irq_level[%d]\n", __func__, irq_level);
	//}
