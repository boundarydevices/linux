	...
	)
{
	...
	{
		RT_TRACE(COMP_COEX, DBG_LOUD, ("[BTCoex], A2dp, wifi/bt rssi both LOW!!\n"));
		bLongDist = TRUE;
	}
	if(bLongDist)
	{
	...
	else
	{
		...
		switch(pCoexDm->curAlgorithm)
		{
			...
			case BT_8192E_2ANT_COEX_ALGO_HID_A2DP:
				...
				break;
			default:
				RT_TRACE(COMP_COEX, DBG_LOUD, ("[BTCoex], Action 2-Ant, algorithm = unknown!!\n"));
