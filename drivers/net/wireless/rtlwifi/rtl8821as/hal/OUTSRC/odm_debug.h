...
VOID 
ODM_InitDebugSetting(IN		PDM_ODM_T		pDM_Odm);

#define	BB_TMP_BUF_SIZE		100
VOID odm_BB_Debug_Info(IN PDM_ODM_T pDM_Odm);
VOID odm_BasicProfile(IN		PVOID			pDM_VOID);
VOID odm_BasicDbgMessage(	IN		PVOID			pDM_VOID);
#endif	// __ODM_DBG_H__
