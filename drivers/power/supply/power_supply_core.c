...
int power_supply_set_current_limit(struct power_supply *psy, int limit)
{
	...
	if (psy->desc->set_property)
		return psy->desc->set_property(psy, POWER_SUPPLY_PROP_CURRENT_MAX,
								&ret);
...
int power_supply_set_health_state(struct power_supply *psy, int health)
{
	...
	if (psy->desc->set_property)
		return psy->desc->set_property(psy, POWER_SUPPLY_PROP_HEALTH,
		&ret);
	return -ENXIO;
}
...
int power_supply_set_scope(struct power_supply *psy, int scope)
{
	...
	if (psy->desc->set_property)
		return psy->desc->set_property(psy, POWER_SUPPLY_PROP_SCOPE,
								&ret);
	return -ENXIO;
}
...
int power_supply_set_charge_type(struct power_supply *psy, int charge_type)
{
	...
	if (psy->desc->set_property)
		return psy->desc->set_property(psy, POWER_SUPPLY_PROP_CHARGE_TYPE,
								&ret);
