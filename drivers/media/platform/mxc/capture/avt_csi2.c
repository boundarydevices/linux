...
long avt_csi2_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	...
	uint8_t avt_supported_lane_counts[8] = {0, 0, 0, 0, 0, 0, 0, 0};
		...
		struct v4l2_mbus_config *cfg)
{
	...
	cfg->bus.mipi_csi2.num_data_lanes = 4; /* TODO check why Allied put 2 only */
...
static void avt_csi2_remove(struct i2c_client *client)
{
	struct v4l2_subdev *sd = i2c_get_clientdata(client);
