...
#define VIDO_DITHER_CON_MASK            0x0fffffff
...
#define VIDO_PVRIC_MASK                 0xffffffff
...
#define VIDO_AFBC_YUVTRANS_MASK         0xffffffff
#define VIDO_OFST_ADDR_HIGH_MASK        0xffffffff
#define VIDO_OFST_ADDR_HIGH_C_MASK      0xffffffff
#define VIDO_OFST_ADDR_HIGH_V_MASK      0xffffffff
