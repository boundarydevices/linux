...
static const struct reg_value ov5640_lenc_settings[] = {
	{0x5180, 0xff, 0, 0}, {0x5181, 0xf2, 0, 0}, {0x5182, 0x00, 0, 0},
	{0x5183, 0x14, 0, 0}, {0x5184, 0x25, 0, 0}, {0x5185, 0x24, 0, 0},
	{0x5186, 0x10, 0, 0}, {0x5187, 0x10, 0, 0}, {0x5188, 0x10, 0, 0},
	{0x5189, 0x6d, 0, 0}, {0x518a, 0x53, 0, 0}, {0x518b, 0x90, 0, 0},
	{0x518c, 0x8c, 0, 0}, {0x518d, 0x3b, 0, 0}, {0x518e, 0x2c, 0, 0},
	{0x518f, 0x59, 0, 0}, {0x5190, 0x42, 0, 0}, {0x5191, 0xf8, 0, 0},
	{0x5192, 0x04, 0, 0}, {0x5193, 0x70, 0, 0}, {0x5194, 0xf0, 0, 0},
	{0x5195, 0xf0, 0, 0}, {0x5196, 0x03, 0, 0}, {0x5197, 0x01, 0, 0},
	{0x5198, 0x04, 0, 0}, {0x5199, 0x00, 0, 0}, {0x519a, 0x04, 0, 0},
	{0x519b, 0x13, 0, 0}, {0x519c, 0x06, 0, 0}, {0x519d, 0x9e, 0, 0},
	{0x519e, 0x38, 0, 0}, {0x5800, 0x2a, 0, 0}, {0x5801, 0x1a, 0, 0},
	{0x5802, 0x13, 0, 0}, {0x5803, 0x13, 0, 0}, {0x5804, 0x1b, 0, 0},
	{0x5805, 0x2b, 0, 0}, {0x5806, 0x10, 0, 0}, {0x5807, 0x09, 0, 0},
	{0x5808, 0x07, 0, 0}, {0x5809, 0x07, 0, 0}, {0x580a, 0x0a, 0, 0},
	{0x580b, 0x10, 0, 0}, {0x580c, 0x08, 0, 0}, {0x580d, 0x03, 0, 0},
	{0x580e, 0x00, 0, 0}, {0x580f, 0x00, 0, 0}, {0x5810, 0x04, 0, 0},
	{0x5811, 0x09, 0, 0}, {0x5812, 0x09, 0, 0}, {0x5813, 0x03, 0, 0},
	{0x5814, 0x00, 0, 0}, {0x5815, 0x00, 0, 0}, {0x5816, 0x04, 0, 0},
	{0x5817, 0x09, 0, 0}, {0x5818, 0x0d, 0, 0}, {0x5819, 0x06, 0, 0},
	{0x581a, 0x03, 0, 0}, {0x581b, 0x04, 0, 0}, {0x581c, 0x06, 0, 0},
	{0x581d, 0x0d, 0, 0}, {0x581e, 0x21, 0, 0}, {0x581f, 0x11, 0, 0},
	{0x5820, 0x0a, 0, 0}, {0x5821, 0x0a, 0, 0}, {0x5822, 0x13, 0, 0},
	{0x5823, 0x23, 0, 0}, {0x5824, 0x13, 0, 0}, {0x5825, 0x24, 0, 0},
	{0x5826, 0x24, 0, 0}, {0x5827, 0x22, 0, 0}, {0x5828, 0x04, 0, 0},
	{0x5829, 0x10, 0, 0}, {0x582a, 0x22, 0, 0}, {0x582b, 0x22, 0, 0},
	{0x582c, 0x22, 0, 0}, {0x582d, 0x22, 0, 0}, {0x582e, 0x10, 0, 0},
	{0x582f, 0x22, 0, 0}, {0x5830, 0x42, 0, 0}, {0x5831, 0x22, 0, 0},
	{0x5832, 0x22, 0, 0}, {0x5833, 0x10, 0, 0}, {0x5834, 0x22, 0, 0},
	{0x5835, 0x22, 0, 0}, {0x5836, 0x22, 0, 0}, {0x5837, 0x00, 0, 0},
	{0x5838, 0x12, 0, 0}, {0x5839, 0x12, 0, 0}, {0x583a, 0x10, 0, 0},
	{0x583b, 0x10, 0, 0}, {0x583c, 0x02, 0, 0}, {0x583d, 0xce, 0, 0},
};
...
static int ov5640_restore_mode(struct ov5640_dev *sensor)
{
	...
	ov5640_load_regs(sensor, ov5640_lenc_settings,
			 ARRAY_SIZE(ov5640_lenc_settings));
