/*
 * drivers/amlogic/media/vin/tvin/hdmirx/hdmi_rx_reg.h
 *
...
#define HHI_HDMIRX_CLK_CNTL				0x200
#define HHI_HDMIRX_AUD_CLK_CNTL			0x204
...
#define HHI_AUD_PLL_CNTL_I				(0xfe * 4)
...
/** main FSM status 1: bit'8=clk stable;bit[9:10]=pll rate*/
...
#define TOP_CLK_CNTL                    0x001
	...
	#define HDCP22_ESMCLK_EN			_BIT(4)
	#define HDCP22_SKPCLK_EN			_BIT(5)
...
/* HDMI 2.0 Features Control Register*/
#define DWC_HDMI20_CONTROL				0x0800
/** SCDC I2C Configuration Register*/
#define DWC_SCDC_I2CCONFIG				0x0804
/** SCDC Configuration Register:HPD & 5v cntl*/
#define DWC_SCDC_CONFIG					0x0808
/** Channel Lock Configuration Register*/
...
/** SCDC Manufacturer Specific Write Data Registers*/
...
/** HDMI 2.0 Status Register:scrambdet*/
#define DWC_HDMI20_STATUS               0x08E0
/** HDCP 2.2 Status Register*/
#define DWC_HDCP22_STATUS               0x08FC

/** Packet Dynamic Range and Mastering Header*/
#define DWC_PDEC_DRM_HB				     0x4c0
/** Packet Dynamic Range and Mastering Payload x Register*/
...
/*type:0x87*/
#define PFIFO_DRM_EN					_BIT(29)
/*type:0x0D*/
#define PFIFO_AMP_EN					_BIT(28)
/*type:0x86*/
#define PFIFO_NTSCVBI_EN				_BIT(27)
/*type:0x85*/
#define PFIFO_MPEGS_EN					_BIT(26)
/*type:0x84*/
#define PFIFO_AUD_EN					_BIT(25)
/*type:0x83*/
#define PFIFO_SPD_EN					_BIT(24)
/*type:0x82*/
#define PFIFO_AVI_EN					_BIT(23)
/*type:0x81*/
#define PFIFO_VS_EN						_BIT(22)
/*type:0x0A*/
#define PFIFO_GMT_EN					_BIT(21)
/*type:0x06*/
#define PFIFO_ISRC2_EN					_BIT(20)
/*type:0x05*/
#define PFIFO_ISRC1_EN					_BIT(19)
/*type:0x04*/
#define PFIFO_ACP_EN					_BIT(18)
/*type:0x03*/
#define PFIFO_GCP_EN					_BIT(17)
/*type:0x01*/
#define PFIFO_ACR_EN					_BIT(16)
...
#define DWC_PDEC_DBG_CTRL				(0x310UL)/*968 966 txl*/
...
/** Packet Decoder Vendor-Specific Infoframe Status Register 0*/
#define DWC_PDEC_VSI_ST0				(0x3E0UL)
#define IEEE_REG_ID						MSK(24, 0)
/** Packet Decoder Vendor-Specific Infoframe Status Register 1*/
...
/** Packet VSI Vendor Specific Payload Register*/
...
/** Packet Decoder Vendor-Specific Infoframe Register*/
...
/** Audio Metadata Packet - Header Content Register
 *This register holds the content of the header of the last
 *Audio Metadata packet received
 */
#define DWC_PDEC_AMP_HB					(0x480UL)
/** Audio Metadata Packet - Payload Content Register x
 *This register holds the content of the payload of the last
 *Audio Metadata packet received.
 */
...
/** Packet NTSC Vertical Blanking Interval Header*/
#define DWC_PDEC_NTSCVBI_HB				(0x4a0UL)
/** Packet NTSC Vertical Blanking Interval Payload 0 Register*/
...
/** External HDCP 2.0 Interrupt - Enable clear Register*/
#define DWC_HDMI2_IEN_CLR				(0xf60UL)
/** External HDCP 2.0 Interrupt - Enable Set Register*/
#define DWC_HDMI2_IEN_SET				(0xF64UL)
/** External HDCP 2.0 Interrupt Flag Register*/
#define DWC_HDMI2_ISTS					(0xF68UL)
/** External HDCP 2.0 Interrupt Enable Status Register*/
#define DWC_HDMI2_IEN					(0xF6CUL)
/** External HDCP 2.0 Interrupt Flag Clear Register*/
