...
/* tdma_in */
static const unsigned int tdma_slv_sclk_pins[] = {GPIOX_12};
static const unsigned int tdma_slv_fs_pins[] = {GPIOX_13};
...
static const unsigned int tdma_dout1_x15_pins[] = {GPIOX_15};

/* tdmb_in */
static const unsigned int tdmb_slv_sclk_pins[] = {GPIOA_8};
static const unsigned int tdmb_slv_fs_pins[] = {GPIOA_9};
static const unsigned int tdmb_din0_pins[] = {GPIOA_10};
static const unsigned int tdmb_din1_pins[] = {GPIOA_11};
static const unsigned int tdmb_din2_a12_pins[] = {GPIOA_12};
static const unsigned int tdmb_din3_a13_pins[] = {GPIOA_13};
static const unsigned int tdmb_din2_a17_pins[] = {GPIOA_17};
static const unsigned int tdmb_din3_a18_pins[] = {GPIOA_18};
...
static const unsigned int tdmb_dout2_a12_pins[] = {GPIOA_12};
static const unsigned int tdmb_dout3_a13_pins[] = {GPIOA_13};
static const unsigned int tdmb_dout2_a17_pins[] = {GPIOA_17};
static const unsigned int tdmb_dout3_a18_pins[] = {GPIOA_18};

/* tdmc_in */
static const unsigned int tdmc_slv_sclk_pins[] = {GPIOA_2};
static const unsigned int tdmc_slv_fs_pins[] = {GPIOA_3};
static const unsigned int tdmc_din0_pins[] = {GPIOA_4};
static const unsigned int tdmc_din1_pins[] = {GPIOA_5};
static const unsigned int tdmc_din2_a6_pins[] = {GPIOA_6};
static const unsigned int tdmc_din3_a7_pins[] = {GPIOA_7};
static const unsigned int tdmc_din2_a15_pins[] = {GPIOA_15};
static const unsigned int tdmc_din3_a16_pins[] = {GPIOA_16};
...
static const unsigned int tdmc_dout2_a6_pins[] = {GPIOA_6};
static const unsigned int tdmc_dout3_a7_pins[] = {GPIOA_7};
static const unsigned int tdmc_dout2_a15_pins[] = {GPIOA_15};
static const unsigned int tdmc_dout3_a16_pins[] = {GPIOA_16};
...
static struct meson_pmx_group meson_axg_periphs_groups[] = {
	...
	GROUP(tdmb_din0,		2),
	GROUP(tdmb_din1,		2),
	GROUP(tdmb_din2_a12,		2),
	GROUP(tdmb_din3_a13,		2),
	GROUP(tdmb_din2_a17,		4),
	GROUP(tdmb_din3_a18,		4),
	GROUP(tdmb_sclk,		1),
	GROUP(tdmb_fs,			1),
	GROUP(tdmb_dout0,		1),
	GROUP(tdmb_dout1,		1),
	GROUP(tdmb_dout2_a12,		1),
	GROUP(tdmb_dout3_a13,		1),
	GROUP(tdmb_dout2_a17,		2),
	GROUP(tdmb_dout3_a18,		2),
	GROUP(tdmc_slv_sclk,		2),
	GROUP(tdmc_slv_fs,		2),
	GROUP(tdmc_din0,		2),
	GROUP(tdmc_din1,		2),
	GROUP(tdmc_din2_a6,		2),
	GROUP(tdmc_din3_a7,		2),
	GROUP(tdmc_din2_a15,		4),
	GROUP(tdmc_din3_a16,		4),
	GROUP(tdmc_sclk,		1),
	GROUP(tdmc_fs,			1),
	GROUP(tdmc_dout0,		1),
	GROUP(tdmc_dout1,		1),
	GROUP(tdmc_dout2_a6,		1),
	GROUP(tdmc_dout3_a7,		1),
	GROUP(tdmc_dout2_a15,		2),
	GROUP(tdmc_dout3_a16,		2),
};
...
static const char * const tdma_out_groups[] = {
	"tdma_sclk", "tdma_fs", "tdma_dout0_x14", "tdma_dout0_x15",
	"tdma_slv_sclk", "tdma_slv_fs", "tdma_dout1_x15",
};

static const char * const tdmb_in_groups[] = {
	"tdmb_slv_sclk", "tdmb_slv_fs", "tdmb_din0", "tdmb_din1",
	"tdmb_din2_a12", "tdmb_din3_a13",
	"tdmb_din2_a17", "tdmb_din3_a18",
	"tdmb_sclk", "tdmb_fs",
};

static const char * const tdmb_out_groups[] = {
	"tdmb_sclk", "tdmb_fs", "tdmb_dout0", "tdmb_dout1",
	"tdmb_dout2_a12", "tdmb_dout3_a13",
	"tdmb_dout2_a17", "tdmb_dout3_a18",
	"tdmb_slv_sclk", "tdmb_slv_fs",
};

static const char * const tdmc_in_groups[] = {
	"tdmc_slv_sclk", "tdmc_slv_fs", "tdmc_din0", "tdmc_din1",
	"tdmc_din2_a6", "tdmc_din3_a7",
	"tdmc_din2_a15", "tdmc_din3_a16",
	"tdmc_sclk", "tdmc_fs",
};
...
static struct meson_bank meson_axg_periphs_banks[] = {
	...
	BANK("Z",    GPIOZ_0,    GPIOZ_10,
	14,  3,  0,  3,  0,  9,  0,  10, 0,  11, 0),
	BANK("BOOT", BOOT_0,     BOOT_14,
	25,  4,  0,  4,  0,  12, 0,  13, 0,  14, 0),
	BANK("A",    GPIOA_0,    GPIOA_20,
	40,  0,  0,  0,  0,  0,  0,  1,  0,  2,  0),
	BANK("X",    GPIOX_0,    GPIOX_22,
	61,  2,  0,  2,  0,  6,  0,  7,  0,  8,  0),
	BANK("Y",    GPIOY_0,    GPIOY_15,
