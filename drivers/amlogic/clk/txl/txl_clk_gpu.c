/*
 * drivers/amlogic/clk/txl/txl_clk_gpu.c
 *
...
static struct clk_mux *txl_gpu_clk_muxes[] = {
	&gpu_p0_mux,
	&gpu_p1_mux,
	&gpu_mux,
};

static struct clk_divider *txl_gpu_clk_divs[] = {
	&gpu_p0_div,
	&gpu_p1_div,
};

static struct clk_gate *txl_gpu_clk_gates[] = {
	&gpu_p0_gate,
	&gpu_p1_gate,
};
