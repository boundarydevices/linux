...
#define HHI_DEMOD_CLK_CNTL		0x1D0 /* 0x74 offset in data sheet */
...
#define HHI_ATV_DMD_SYS_CLK_CNTL	0x3cc /* 0xf3 offset in data sheet */
/* 0xf3 offset in data sheet */
#define HHI_EE_MISC_CNTL			0x3d0
...
/*txl: gp0_pll: Fdco: 0.96G~1.632G Fdco = 24*(M+frac)/N
 *N: recommend is 1
 *gp0_clk_out = Fdco /Fod
 *od=0 Fod=1 od=1 Fod=2 od=2 Fod=4 od=3 Fod=4
 */
static const struct pll_rate_table txl_gp0_pll_rate_table[] = {
