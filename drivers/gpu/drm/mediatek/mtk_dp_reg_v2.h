...
#define SW_IRQ_SRC_DP_TRANS_P0_MASK		GENMASK(15, 0)
...
#define AUX_SWAP_AUX_TX_P0_FLDMASK		BIT(15)
...
#define MTK_DP_AUX_P0_3680		0x3680
#define AUX_SWAP_TX_AUX_TX_P0_FLDMASK		BIT(0)
