...
#define SDP_TESTBUS_SEL_BIT4_DP_ENC_MASK		GENMASK(7, 7)
...
#define AUX_DP_TX_INT_3660_VAL				0xffff
#define AUX_DP_TX_INT_3660_MASK				GENMASK(15, 0)
...
#define DISP_EDPTX_PWR_RST_B				BIT(0)
#define DISP_EDPTX_PWR_CLK_DIS				BIT(4)
...
#define EDP_TX_LN_PRE_EMPH_VAL_FLDMASK			GENMASK(4, 3)
#define PHYD_DIG_DRV_FORCE_LANE_8189(lane)	(0x1018 + 0x100 * (lane))
#define EDP_TX_LN_VOLT_SWING_VAL_8189_FLDMASK		GENMASK(2, 1)
#define EDP_TX_LN_VOLT_SWING_EN_8189			BIT(0)
#define EDP_TX_LN_PRE_EMPH_VAL_8189_FLDMASK		GENMASK(6, 5)
#define EDP_TX_LN_PRE_EMPH_EN_8189			BIT(4)
