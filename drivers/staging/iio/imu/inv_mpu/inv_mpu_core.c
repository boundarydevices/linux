...
static IIO_DEVICE_ATTR(compass_rate, S_IRUGO | S_IWUGO, inv_attr_show,
...
static IIO_DEVICE_ATTR(pressure_rate, S_IRUGO | S_IWUGO, inv_attr_show,
...
static IIO_DEVICE_ATTR(compass_sens, S_IRUGO | S_IWUGO, inv_attr_show,
