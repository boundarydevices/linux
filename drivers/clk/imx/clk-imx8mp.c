...
static const char *imx_hdmi_phy_clks_sels[] = { "osc_24m", "video_pll1_out",};
...
static struct imx_blk_ctrl_hw imx8mp_hdmi_blk_ctrl_hws[] = {
	...
	IMX_BLK_CTRL_CLK_GATE("hdmi_phy_int", IMX8MP_CLK_HDMI_BLK_CTRL_TX_PHY_INT_CLK, 0x50, 24, "hdmi_phy_sel"),
...
static int imx8mp_clocks_probe(struct platform_device *pdev)
{
	...
	hws[IMX8MP_AUDIO_PLL1] = imx_dev_clk_hw_pll14xx(dev, "audio_pll1", "audio_pll1_ref_sel", anatop_base, &imx_1443x_pll);
	hws[IMX8MP_AUDIO_PLL2] = imx_dev_clk_hw_pll14xx(dev, "audio_pll2", "audio_pll2_ref_sel", anatop_base + 0x14, &imx_1443x_pll);
	hws[IMX8MP_VIDEO_PLL1] = imx_dev_clk_hw_pll14xx(dev, "video_pll1", "video_pll1_ref_sel", anatop_base + 0x28, &imx_1443x_pll);
	hws[IMX8MP_DRAM_PLL] = imx_dev_clk_hw_pll14xx(dev, "dram_pll", "dram_pll_ref_sel", anatop_base + 0x50, &imx_1443x_dram_pll);
...
static int __init imx8mp_clk_driver_init(void)
{
	return platform_driver_register(&imx8mp_clk_driver);
}
subsys_initcall(imx8mp_clk_driver_init);

static void __exit imx8mp_clk_driver_exit(void)
{
