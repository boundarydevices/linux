...
static iomux_v3_cfg_t MX6NAME(common_pads)[] = {
	...
	NEW_PAD_CTRL(MX6PAD(DI0_PIN2__IPU1_DI0_PIN2),PAD_CTL_DSE_120ohm),		/* HSync */
	NEW_PAD_CTRL(MX6PAD(DI0_PIN3__IPU1_DI0_PIN3),PAD_CTL_DSE_120ohm),		/* VSync */
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT0__IPU1_DISP0_DAT_0),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT1__IPU1_DISP0_DAT_1),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT2__IPU1_DISP0_DAT_2),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT3__IPU1_DISP0_DAT_3),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT4__IPU1_DISP0_DAT_4),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT5__IPU1_DISP0_DAT_5),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT6__IPU1_DISP0_DAT_6),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT7__IPU1_DISP0_DAT_7),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT8__IPU1_DISP0_DAT_8),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT9__IPU1_DISP0_DAT_9),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT10__IPU1_DISP0_DAT_10),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT11__IPU1_DISP0_DAT_11),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT12__IPU1_DISP0_DAT_12),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT13__IPU1_DISP0_DAT_13),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT14__IPU1_DISP0_DAT_14),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT15__IPU1_DISP0_DAT_15),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT16__IPU1_DISP0_DAT_16),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT17__IPU1_DISP0_DAT_17),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT18__IPU1_DISP0_DAT_18),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT19__IPU1_DISP0_DAT_19),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT20__IPU1_DISP0_DAT_20),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT21__IPU1_DISP0_DAT_21),PAD_CTL_DSE_120ohm),
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT22__IPU1_DISP0_DAT_22),PAD_CTL_DSE_120ohm),
