...
#define GP_HEADPHONE_DET	IMX_GPIO_NR(4, 7)
	MX6PAD(KEY_ROW0__GPIO_4_7),	/* plugged-in=high */
#define GP_AUDIO_MUTE			IMX_GPIO_NR(1, 29)
	MX6PAD(ENET_TXD1__GPIO_1_29),	/* low is muted */
...
#define GP_TC3538_RESET		IMX_GPIO_NR(6, 9)
	MX6PAD(NANDF_WP_B__GPIO_6_9),
#define GP_OV5640_MIPI_RESET	IMX_GPIO_NR(2, 5)
#define GP_TC3538_IRQ		IMX_GPIO_NR(2, 5)
