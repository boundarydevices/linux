...
#define MX6Q_USDHC_PAD_CTRL_47KPU_40OHM_50MHZ 	(PAD_CTL_PKE | PAD_CTL_PUE |	\
		PAD_CTL_PUS_47K_UP  | PAD_CTL_SPEED_LOW |		\
		PAD_CTL_DSE_40ohm   | PAD_CTL_SRE_FAST  | PAD_CTL_HYS)

#define MX6Q_USDHC_PAD_CTRL_47KPU_40OHM_100MHZ 	(PAD_CTL_PKE | PAD_CTL_PUE |	\
		PAD_CTL_PUS_47K_UP  | PAD_CTL_SPEED_MED |		\
		PAD_CTL_DSE_40ohm   | PAD_CTL_SRE_FAST  | PAD_CTL_HYS)

#define MX6Q_USDHC_PAD_CTRL_47KPU_40OHM_200MHZ 	(PAD_CTL_PKE | PAD_CTL_PUE |	\
		PAD_CTL_PUS_47K_UP  | PAD_CTL_SPEED_HIGH |		\
		PAD_CTL_DSE_40ohm   | PAD_CTL_SRE_FAST  | PAD_CTL_HYS)

#define MX6DL_USDHC_PAD_CTRL_47KPU_40OHM_50MHZ MX6Q_USDHC_PAD_CTRL_47KPU_40OHM_50MHZ
#define MX6DL_USDHC_PAD_CTRL_47KPU_40OHM_100MHZ MX6Q_USDHC_PAD_CTRL_47KPU_40OHM_100MHZ
#define MX6DL_USDHC_PAD_CTRL_47KPU_40OHM_200MHZ MX6Q_USDHC_PAD_CTRL_47KPU_40OHM_200MHZ
...
#if !defined(CONFIG_MACH_MX6_NW_REV2)
	/* Storage - SD Card J18 */
	SD_PINS(3, USDHC_PAD_CTRL_47KPU_40OHM_50MHZ),
...
#define GP_EMMC_RESET	IMX_GPIO_NR(2, 5)
	...
	/* USB */
	NEW_PAD_CTRL(MX6PAD(KEY_ROW4__GPIO_4_15),WEAK_PULLUP240),	/* USB Hub reset */
	MX6PAD(GPIO_1__USBOTG_ID),					/* USBOTG ID pin */
	NEW_PAD_CTRL(MX6PAD(EIM_D22__GPIO_3_22), WEAK_PULLUP240),	/* usbotg power */
...
#if !defined(CONFIG_MACH_MX6_NW_REV2)
static iomux_v3_cfg_t MX6_USDHC_PAD_SETTING(3, 50, USDHC_PAD_CTRL_47KPU_40OHM_50MHZ);
static iomux_v3_cfg_t MX6_USDHC_PAD_SETTING(3, 100, USDHC_PAD_CTRL_47KPU_40OHM_100MHZ);
static iomux_v3_cfg_t MX6_USDHC_PAD_SETTING(3, 200, USDHC_PAD_CTRL_47KPU_40OHM_200MHZ);
#else
static iomux_v3_cfg_t MX6_USDHC_PAD_SETTING(4, 50, USDHC_PAD_CTRL_47KPU_40OHM_50MHZ);
static iomux_v3_cfg_t MX6_USDHC_PAD_SETTING(4, 100, USDHC_PAD_CTRL_47KPU_40OHM_100MHZ);
static iomux_v3_cfg_t MX6_USDHC_PAD_SETTING(4, 200, USDHC_PAD_CTRL_47KPU_40OHM_200MHZ);
#endif
