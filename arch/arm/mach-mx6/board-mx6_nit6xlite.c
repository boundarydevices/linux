...
#define MX6_N6L_DRYCONTACT		IMX_GPIO_NR(3, 29)	/* J14 pins 8 and 9 - dry contact */
#define MX6_N6L_GP1			IMX_GPIO_NR(1, 7)	/* J46 pin 2 */
#define MX6_N6L_GP2			IMX_GPIO_NR(1, 8)	/* J46 pin 3 */
...
//	{.label = "rtc_i2c_en",		.gpio = RTC_I2C_EN,	.flags = 0},		/* GPIO2[23]: EIM_CS0 - active high */
	...
	{.label = "drycontact",		.gpio = MX6_N6L_DRYCONTACT,	.flags = 0},	/* J14 pins 8/9: GPIO3:29 */
	{.label = "gp1",		.gpio = MX6_N6L_GP1,		.flags = 0},	/* J46 pin 2 */
	{.label = "gp2",		.gpio = MX6_N6L_GP2,		.flags = 0},	/* J46 pin 3 */
