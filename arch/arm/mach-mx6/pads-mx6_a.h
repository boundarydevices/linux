...
#define WEAK (PAD_CTL_PUE | PAD_CTL_PKE | PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_240ohm | PAD_CTL_SPEED_LOW)
#define WEAK_IRQ (WEAK | PAD_CTL_HYS)
...
static iomux_v3_cfg_t MX6NAME(common_pads)[] = {
	...
	/* Real Time Clock-  RV4162 (I2C2) */
	NEW_PAD_CTRL(MX6PAD(KEY_ROW4__GPIO_4_15), WEAK_PULLUP),
