...
{
	camera_reset(-1, 0, GP_ADV7180_RESET, -1);
//	gpio_set_value(GP_ADV7180_PWR, 1);
	msleep(2);
	gpio_set_value(GP_ADV7180_RESET, 1);

	if (cpu_is_mx6q())
		mxc_iomux_set_gpr_register(1, 19 + adv7180_data.csi, 1, 1);
	else
		mxc_iomux_set_gpr_register(13, adv7180_data.csi * 3, 3, 4);
}
