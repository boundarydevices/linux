...
static const iomux_v3_cfg_t MX6NAME(board_pads)[] = {
	...
	NEW_PAD_CTRL(MX6PAD(NANDF_CS2__CCM_CLKO2), OUTPUT_40OHM),	/* MCLK1, also to TC3587 Refclk 26/27/42 */
//	NEW_PAD_CTRL(MX6PAD(NANDF_CS2__GPIO_6_15), PADCFG_INPUT),	/* MCLK1, also to TC3587 Refclk 26/27/42 */
...
#define GP_WM5102_LDO_EN	IMX_GPIO_NR(5, 11)
	...
	/* camera - video0 - ADV7180 - I2C3, crsytal 28.636 MHz */
...
#define GP_J3_CARRIER_SENSE	IMX_GPIO_NR(7, 4)
	NEW_PAD_CTRL(MX6PAD(SD3_DAT0__GPIO_7_4), PADCFG_FLOAT_IRQ),	/* J3 pin 7 */


#define GP_PTT_ON	IMX_GPIO_NR(7, 5)
	NEW_PAD_CTRL(MX6PAD(SD3_DAT1__GPIO_7_5), PADCFG_FLOAT_IRQ),	/* J3 pin 7 */
#define GP_GPS_RESET	IMX_GPIO_NR(7, 1)
	NEW_PAD_CTRL(MX6PAD(SD3_DAT4__GPIO_7_1), PADCFG_FLOAT_IRQ),	/* J3 pin 7 */
