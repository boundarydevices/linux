...
#define OUTPUT_40OHM_UP	(OUTPUT_40OHM | PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)

#define SPI_PAD_CTRL (PADCFG_INPUT_DN | PAD_CTL_SRE_FAST)
...
#define GP_ANX7814_P_DWN	IMX_GPIO_NR(1, 13)
	NEW_PAD_CTRL(MX6PAD(SD2_DAT2__GPIO_1_13), WEAK_PULLUP),	/* O_HDMI_PD */
#define GP_ANX7814_RESET	IMX_GPIO_NR(2, 5)
	NEW_PAD_CTRL(MX6PAD(NANDF_D5__GPIO_2_5), WEAK_PULLUP),	/* O_HDMI_RESET_N */
#define GP_ANX7814_CBL_DET	IMX_GPIO_NR(2, 3)
	NEW_PAD_CTRL(MX6PAD(NANDF_D3__GPIO_2_3), WEAK_PULLUP),	/* O_HDMI_MYDP_DET_INTR */
	NEW_PAD_CTRL(MX6PAD(SD2_DAT1__GPIO_1_14), WEAK_PULLUP),	/* O_HDMI_INTR */

#define GP_ANX7738_RESET	IMX_GPIO_NR(2, 0)
	NEW_PAD_CTRL(MX6PAD(NANDF_D0__GPIO_2_0), WEAK_PULLUP),	/* I_HDMI_RESET_N */
...
#define GP_ECSPI1_CS1		IMX_GPIO_NR(3, 19)
	NEW_PAD_CTRL(MX6PAD(EIM_D19__GPIO_3_19), OUTPUT_40OHM_UP),		/* SS1 */
...
#define GP_ECSPI2_GS2971_CS	IMX_GPIO_NR(2, 26)
	NEW_PAD_CTRL(MX6PAD(EIM_RW__GPIO_2_26), OUTPUT_40OHM_UP),
...
#define GP_ECSPI3_WM5102_CS	IMX_GPIO_NR(4, 25)
	NEW_PAD_CTRL(MX6PAD(DISP0_DAT4__GPIO_4_25), OUTPUT_40OHM_UP),
...
#define GP_ANX7814_IRQ		IMX_GPIO_NR(2, 3)
	NEW_PAD_CTRL(MX6PAD(NANDF_D3__GPIO_2_3), WEAK_PULLUP),
#define GP_ANX7814_POWER_DOWN	IMX_GPIO_NR(1, 13)
	NEW_PAD_CTRL(MX6PAD(SD2_DAT2__GPIO_1_13), WEAK_PULLDN),

	/* I2C1, microcontroller KL04Z32TFK4, TC3587 */
	MX6PAD(EIM_D21__I2C1_SCL),	/* GPIO3[21] */
	MX6PAD(EIM_D28__I2C1_SDA),	/* GPIO3[28] */
#define GP_TC3587_I2C_EN	IMX_GPIO_NR(6, 16)
	NEW_PAD_CTRL(MX6PAD(NANDF_CS3__GPIO_6_16), WEAK_PULLDN),
#define GP_KL04_I2c_EN		IMX_GPIO_NR(5, 27)
	NEW_PAD_CTRL(MX6PAD(CSI0_DAT9__GPIO_5_27), WEAK_PULLDN),
#define GP_ANX7814_I2C_EN	IMX_GPIO_NR(1, 10)
	NEW_PAD_CTRL(MX6PAD(SD2_CLK__GPIO_1_10), WEAK_PULLDN),
#define GP_AX7738_I2C_EN	IMX_GPIO_NR(2, 1)
	NEW_PAD_CTRL(MX6PAD(NANDF_D1__GPIO_2_1), WEAK_PULLDN),

	/* I2C2 hdmi edid */
	MX6PAD(KEY_COL3__I2C2_SCL),	/* GPIO4[12] */
	MX6PAD(KEY_ROW3__I2C2_SDA),	/* GPIO4[13] */
#define GP_ANX7814_DDC_I2C_EN	IMX_GPIO_NR(1, 15)
	NEW_PAD_CTRL(MX6PAD(SD2_DAT0__GPIO_1_15), WEAK_PULLDN),
...
#define GP_J11_HDMI_POWER_EN		IMX_GPIO_NR(7, 3)
	NEW_PAD_CTRL(MX6PAD(SD3_CLK__GPIO_7_3), OUTPUT_40OHM_UP),	/* power on J11 pin 3 */
