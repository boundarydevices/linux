...
#define CAP_TCH_INT	IMX_GPIO_NR(1, 9)
...
static struct fec_platform_data fec_data __initdata = {
	...
	.phy_irq = gpio_to_irq(ENET_PHY_INT)
};
...
static struct gpio_keys_button buttons[] = {
	GPIO_BUTTON(IMX_GPIO_NR(3, 3), KEY_KP2, 1, "S2", 1),
	GPIO_BUTTON(IMX_GPIO_NR(3, 4), KEY_KP4, 1, "S4", 1),
	GPIO_BUTTON(IMX_GPIO_NR(3, 5), KEY_KP3, 1, "S3", 1),
};
...
pr_err("%s:%s\n", __FILE__, __func__);
	...
	printk(KERN_ERR "------------ Board type MED\n");
