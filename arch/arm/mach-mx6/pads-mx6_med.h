...
#define WEAK_PULLUP (PAD_CTL_HYS | PAD_CTL_PUE | PAD_CTL_PKE | PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_40ohm | PAD_CTL_SPEED_LOW)
#define WEAK_PULLDN (PAD_CTL_HYS | PAD_CTL_PUE | PAD_CTL_PKE | PAD_CTL_PUS_100K_DOWN | PAD_CTL_DSE_40ohm | PAD_CTL_SPEED_LOW)
...
static iomux_v3_cfg_t MX6NAME(common_pads)[] = {
	...
	/* USDHC4 */
	SD_PINS(4, USDHC_PAD_CTRL_22KPU_40OHM_50MHZ),
#define GP_USDHC4_CD	IMX_GPIO_NR(2, 6)
	NEW_PAD_CTRL(MX6PAD(NANDF_D6__GPIO_2_6), WEAK_PULLUP),	/* SD4_CD */
#define GP_USDHC4_WP	IMX_GPIO_NR(2, 7)
	NEW_PAD_CTRL(MX6PAD(NANDF_D7__GPIO_2_7), WEAK_PULLDN),	/* SD4_WP */

	/* USDHC3 */
	SD_PINS(3, USDHC_PAD_CTRL_50MHZ),
#define GP_USDHC3_CD	IMX_GPIO_NR(7, 0)
	NEW_PAD_CTRL(MX6PAD(SD3_DAT5__GPIO_7_0), WEAK_PULLUP),	/* SD3_CD */
#define GP_USDHC3_WP	IMX_GPIO_NR(7, 1)
	NEW_PAD_CTRL(MX6PAD(SD3_DAT4__GPIO_7_1), WEAK_PULLDN),	/* SD3_WP */
