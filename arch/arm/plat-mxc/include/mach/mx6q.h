...
/* Reserve some size for bus freq and suspend/resume 16K totally */
#define MX6Q_IRAM_SIZE                  (SZ_256K - SZ_16K)
#define MX6Q_IRAM_BUSFREQ_DATA1_ADDR	(MX6Q_IRAM_BASE_ADDR + MX6Q_IRAM_SIZE)
#define MX6Q_IRAM_BUSFREQ_DATA2_ADDR	(MX6Q_IRAM_BASE_ADDR + MX6Q_IRAM_SIZE + SZ_2K)
#define MX6Q_IRAM_BUSFREQ_CODE_ADDR	(MX6Q_IRAM_BASE_ADDR + MX6Q_IRAM_SIZE + SZ_2K + SZ_2K)
#define MX6Q_IRAM_SUSPEND_ADDR		(MX6Q_IRAM_BASE_ADDR + MX6Q_IRAM_SIZE + SZ_2K + SZ_2K + SZ_8K)
/*
