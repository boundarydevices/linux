...
static bool pkvm_ext_allowed(struct kvm *kvm, long ext)
{
	...
	case KVM_CAP_ARM_SVE:
		return FIELD_GET(ARM64_FEATURE_MASK(ID_AA64PFR0_EL1_SVE),
				 PVM_ID_AA64PFR0_ALLOW);
	case KVM_CAP_ARM_PTRAUTH_ADDRESS:
		return FIELD_GET(ARM64_FEATURE_MASK(ID_AA64ISAR1_EL1_API),
				 PVM_ID_AA64ISAR1_ALLOW) &&
		       FIELD_GET(ARM64_FEATURE_MASK(ID_AA64ISAR1_EL1_APA),
				 PVM_ID_AA64ISAR1_ALLOW);
	case KVM_CAP_ARM_PTRAUTH_GENERIC:
		return FIELD_GET(ARM64_FEATURE_MASK(ID_AA64ISAR1_EL1_GPI),
				 PVM_ID_AA64ISAR1_ALLOW) &&
