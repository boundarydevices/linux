...
#define IMX95_CLK_DISPMIX_LVDS_CH_GATE		0
#define IMX95_CLK_DISPMIX_PIX_DI_GATE		1
#define IMX95_CLK_DISPMIX_LVDS_PLL_GATE		2
#define IMX95_CLK_DISPMIX_LVDS_CSR_END		3
...
#define IMX95_CLK_CAMBLK_ISI_AXI	2
#define IMX95_CLK_CAMBLK_ISP_AXI	3
#define IMX95_CLK_CAMBLK_ISP_PIXEL	4
#define IMX95_CLK_CAMBLK_ISP		5
#define IMX95_CLK_CAMBLK_END		6
