...
#define CLKID_SAR_ADC		  (GATE_BASE0 + 7)
...
#define CLKID_SPI (GATE_BASE0 + 21)
/*HHI_GCLK_MPEG1: 0x51*/
#define GATE_BASE1    (GATE_BASE0 + 22) /*25+22*/
#define CLKID_I2S_SPDIF		  (GATE_BASE1 + 0)
#define CLKID_ETH		  (GATE_BASE1 + 1)
#define CLKID_DEMUX		  (GATE_BASE1 + 2)
#define CLKID_AIU_GLUE		  (GATE_BASE1 + 3)
#define CLKID_IEC958		  (GATE_BASE1 + 4)
#define CLKID_I2S_OUT		  (GATE_BASE1 + 5)
#define CLKID_AMCLK		  (GATE_BASE1 + 6)
#define CLKID_AIFIFO2		  (GATE_BASE1 + 7)
#define CLKID_MIXER		  (GATE_BASE1 + 8)
#define CLKID_MIXER_IFACE	  (GATE_BASE1 + 9)
#define CLKID_ADC		  (GATE_BASE1 + 10)
#define CLKID_BLKMV		  (GATE_BASE1 + 11)
#define CLKID_AIU		  (GATE_BASE1 + 12)
#define CLKID_UART1		  (GATE_BASE1 + 13)
#define CLKID_G2D		  (GATE_BASE1 + 14)
#define CLKID_USB0    (GATE_BASE1 + 15)
#define CLKID_USB1    (GATE_BASE1 + 16)
#define CLKID_RESET		  (GATE_BASE1 + 17)
#define CLKID_NAND		  (GATE_BASE1 + 18)
#define CLKID_DOS_PARSER	  (GATE_BASE1 + 19)
#define CLKID_USB      (GATE_BASE1 + 20)
#define CLKID_VDIN1		  (GATE_BASE1 + 21)
#define CLKID_AHB_ARB0		  (GATE_BASE1 + 22)
#define CLKID_EFUSE		  (GATE_BASE1 + 23)
#define CLKID_BOOT_ROM		  (GATE_BASE1 + 24)
/*HHI_GCLK_MPEG2: 0x52*/
#define GATE_BASE2    (GATE_BASE1 + 25)  /*25+22+25*/
#define CLKID_AHB_DATA_BUS	  (GATE_BASE2 + 0)
#define CLKID_AHB_CTRL_BUS	  (GATE_BASE2 + 1)
#define CLKID_HDMI_INTR_SYNC	  (GATE_BASE2 + 2)
#define CLKID_HDMI_PCLK		  (GATE_BASE2 + 3)
#define CLKID_USB1_DDR_BRIDGE (GATE_BASE2 + 4)
#define CLKID_USB0_DDR_BRIDGE (GATE_BASE2 + 5)
#define CLKID_MMC_PCLK		  (GATE_BASE2 + 6)
#define CLKID_DVIN		  (GATE_BASE2 + 7)
#define CLKID_UART2		  (GATE_BASE2 + 8)
#define CLKID_SANA		  (GATE_BASE2 + 9)
#define CLKID_VPU_INTR		  (GATE_BASE2 + 10)
#define CLKID_SEC_AHB_AHB3_BRIDGE (GATE_BASE2 + 11)
#define CLKID_CLK81_A53		  (GATE_BASE2 + 12)
/*HHI_GCLK_OTHER: 0x54*/
#define GATE_BASE3    (GATE_BASE2 + 13) /*25+22+25+13*/
...
#define CLKID_GCLK_VENCI_INT0	  (GATE_BASE3 + 4)
#define CLKID_GCLK_VENCI_INT	  (GATE_BASE3 + 5)
#define CLKID_DAC_CLK		  (GATE_BASE3 + 6)
#define CLKID_AOCLK_GATE	  (GATE_BASE3 + 7)
#define CLKID_IEC958_GATE	  (GATE_BASE3 + 8)
#define CLKID_ENC480P		  (GATE_BASE3 + 9)
#define CLKID_RNG1		  (GATE_BASE3 + 10)
#define CLKID_GCLK_VENCI_INT1	  (GATE_BASE3 + 11)
#define CLKID_VCLK2_VENCLMCC	  (GATE_BASE3 + 12)
#define CLKID_VCLK2_VENCL	  (GATE_BASE3 + 13)
#define CLKID_VCLK_OTHER	  (GATE_BASE3 + 14)
#define CLKID_EDP		  (GATE_BASE3 + 15)

#define AO_BASE (GATE_BASE3 + 16) /*25+22+25+13+16*/
...
#define OTHER_BASE (AO_BASE + 5) /*25+22+25+13+16+5=106*/
...
#define CLKID_GPU_BASE (OTHER_BASE + 24) /*25+22+25+13+16+5+24*/
...
#define CLKID_MEDIA_BASE (CLKID_GPU_BASE + 9) /*25+22+25+13+16+5+24+9*/
