...
int dev_pm_opp_of_add_table_indexed_np(struct device *dev, int index,
		bool getclk, struct device_node *np,
...
static inline int dev_pm_opp_of_add_table_indexed_np(struct device *dev, int index,
		bool getclk, struct device_node *np,
		struct device_node **ref_np, int max_tables)
{
	return -EOPNOTSUPP;
