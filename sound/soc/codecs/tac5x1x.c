...
static const struct snd_kcontrol_new taa5x1x_controls[] = {
	...
	SOC_SINGLE("IN_CH1_EN Capture Switch", TAC5X1X_CH_EN, 7, 1, 1),
	SOC_SINGLE("IN_CH2_EN Capture Switch", TAC5X1X_CH_EN, 6, 1, 1),
...
static const struct snd_kcontrol_new tad5x1x_controls[] = {
	...
	SOC_SINGLE("OUT_CH1_EN Playback Switch", TAC5X1X_CH_EN, 3, 1, 1),
	SOC_SINGLE("OUT_CH2_EN Playback Switch", TAC5X1X_CH_EN, 2, 1, 1),
...
static const struct reg_default tac5x1x_reg_defaults[] = {
	{TAC5X1X_PGSEL, 0x00},
	{TAC5X1X_INT, 0x10},
	{TAC5X1X_ADCCH1C0, 0x44},
	{TAC5X1X_ADCCH2C0, 0x44},
	{TAC5X1X_OUT1CFG0, 0x28},
	{TAC5X1X_OUT2CFG0, 0x28},
	{TAC5X1X_CH_EN, 0xCC},
	{TAC5X1X_ASI1, 0x10},
	{TAC5X1X_PASITXCH1, 0x21},
	{TAC5X1X_PASITXCH2, 0x20},
