...
enum rpmsg_pcm512x_sclk_src {
	PCM512x_SYSCLK_MCLK1,
	PCM512x_SYSCLK_MCLK2,
	PCM512x_SYSCLK_NOCLK,
};

extern const struct dev_pm_ops rpmsg_pcm512x_pm_ops;
extern const struct regmap_config rpmsg_pcm512x_regmap;

int rpmsg_pcm512x_probe(struct device *dev, struct regmap *regmap);
void rpmsg_pcm512x_remove(struct device *dev);
